...
/* var rootOBjList = JsonConvert.DeserializeObject<List<Device>>(json);




 objects.AddRange(rootOBjList);
...
/*string csvapath = " F:\\file7.json";
//  csva.AppendLine("Id;DeviceUuid;DeviceName;DeviceDescription;DeviceState;SystemTags;UserTags;LastReading;AddedAt;Updated;MacAddress;OwnerID;OwnerUuid;	OwnerUserName;OwnerAvatar;OwnerUrl;OwnerJoinDate;OwnerCity;OwnerCountry;OwnerCountryCode;DataRecorded_At;DataAdded_At;DataLocation;DataExposure;DataElevation;DataLatitude;DataLongitude;DataGeoLocation;DataCity;DataCountryCode;DataCountry;BSensorsId;BSensortAncestry;BSensorName;BSensorDescription;BSensorUnit;BSensorCreatedAt;BSensorUpdated_at;BSensorMeasurement_id;BSensorUuid;BSensorValue;BSensorRawValue;BSensorPrevValue;BSensorPrevRawValue;SensorsHId;SensortHAncestry;SensorHName;SensorHDescription;SensorHUnit;SensorHCreatedAt;SensorHUpdated_at;SensorHMeasurement_id;SensorHUuid;SensorHValue;SensorHRawValue;SensorHPrevValue;SensorHPrevRawValue;TSensorsId;TSensortAncestry;TSensorName;TSensorDescription;TSensorUnit;TSensorCreatedAt;TSensorUpdated_at;TSensorMeasurement_id;TSensorUuid;TSensorValue;TSensorRawValue;TSensorPrevValue;TSensorPrevRawValue;GasSensorsId;GasSensortAncestry;GasSensorName;GasSensorDescription;GasSensorUnit;GasSensorCreatedAt;GasSensorUpdated_at;GasSensorMeasurement_id;GasSensorUuid;GasSensorValue;GasSensorRawValue;GasSensorPrevValue;GasSensorPrevRawValue;CoSensorsId;CoSensortAncestry;CoSensorName;CoSensorDescription;CoSensorUnit;CoSensorCreatedAt;CoSensorUpdated_at;CoSensorMeasurement_id;CoSensorUuid;CoSensorValue;CoSensorRawValue;CoSensorPrevValue;CoSensorPrevRawValue;NetSensorsId;NetSensortAncestry;NetSensorName;NetSensorDescription;NetSensorUnit;NetSensorCreatedAt;NetSensorUpdated_at;NetSensorMeasurement_id;NetSensorUuid;NetSensorValue;NetSensorRawValue;NetSensorPrevValue;NetSensorPrevRawValue;DBSensorsId;DBSensortAncestry;DbSensorName;	DbSensorDescription;	DbSensorUnit;	DbSensorCreatedAt;	DbSensorUpdated_at;	DbSensorMeasurement_id;	DbSensorUuid;	DbSensorValue;	DbSensorRawValue;	DbSensorPrevValue;	DbSensorPrevRawValue;	LSensorsId;	LSensortAncestry;	LSensorName;	LSensorDescription;LSensorUnit;LSensorCreatedAt;LSensorUpdated_at;LSensorMeasurement_id;LSensorUuid;LSensorValue;LSensorRawValue;LSensorPrevValue;LSensorPrevRawValue;SolSensorsId;SolSensortAncestry;SolSensorName;SolSensorDescription;SolSensorUnit;SolSensorCreatedAt;SolSensorUpdated_at;SolSensorMeasurement_id;SolSensorUuid;SolSensorValue;SolSensorRawValue;SolSensorPrevValue;SolSensorPrevRawValue;KitId;KitUuid;KitSlug;KitName;KitDescription;KitCreatedAt;KitUpdatedAt;");
csva.Append(json);
...
// csv.Append(objects.ToString());
// string csvpath = " F:\\x12.json";
